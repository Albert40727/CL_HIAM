...
class CoattentionNet(nn.Module):
    ...
    """
    def __init__(self, args, embed_dim=512, k=30):
        super().__init__()
    ...
    def forward(self, user_emb, item_emb):                    # Image: B x 512 x 196
        ...
        h_w = self.tanh(self.W_w(v_user + q_item))
